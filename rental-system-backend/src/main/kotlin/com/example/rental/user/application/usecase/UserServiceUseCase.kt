package com.example.rental.user.application.usecase
...
class UserServiceUseCase(
    ...
    private val log = LoggerFactory.getLogger(UserServiceUseCase::class.java)
    ...
    override fun execute(command: CreateUserCommand): UserResponse {
        ...
        val domainUser = command.toDomain(encodedPassword)
